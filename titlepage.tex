...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \centering
    {\Huge \textbf{\textcolor{black}{{Design and Optimisation of an Automotive\\[0.3cm]
    Rear Window Defroster}}}}\\[1.5cm]
    \textsc{\LARGE Multiphysics Modelling Using COMSOL}\\[0.5cm]
    \text{\large ME46095}\\[2cm]
    
    {\Large \textbf{\textcolor{tudelftdarkblue}{Authors:}}}\\[0.5cm]
    \begin{tabular}{c}
        \Large \textcolor{tudelftdarkblue}{Irian ()} \\
        \Large \textcolor{tudelftdarkblue}{Muhammad Sebtain (4532589)} \\
    \end{tabular}\\[2cm]
